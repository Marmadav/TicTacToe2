...
namespace TicTacToe
{
    public class TicTacToe
    {
        ...
        public string CheckWinCondition()
        {
            ...
            {
                File.ReadAllLines(@"C:\ElevenFifty Projects\ElevenFiftyProjects\DotNetProjects\TicTacToe\TicTacToe\X.txt").ToList().ForEach(c => Console.WriteLine(c));
            ...
            {
                File.ReadAllLines(@"C:\ElevenFifty Projects\ElevenFiftyProjects\DotNetProjects\TicTacToe\TicTacToe\O.txt").ToList().ForEach(c => Console.WriteLine(c));
